...
export default function Client() {
  ...
  async function reserverEtPayer() {
    ...
    // NOUVEAU : On ne crée plus la réservation en BDD maintenant ! 
    // On passe juste les informations à la page suivante
    const params = new URLSearchParams({
      c_id: selectedCreneau.id,
      cat: selectedTarif.categorie,
      prix: selectedTarif.prix_cents.toString(),
      fn: form.first_name,
      ln: form.last_name,
      ph: form.phone,
      em: form.email,
      sac: form.sacrifice_name,
      heure: selectedCreneau.heure_debut
    });

    window.location.assign(`/paiement-stripe?${params.toString()}`);
  }
